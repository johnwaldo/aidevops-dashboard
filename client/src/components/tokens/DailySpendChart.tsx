...
export function DailySpendChart() {
  ...
  const dailyAvg = budget.currentMonth / budget.dailyHistory.length;
  ...
  return (
    <div className="rounded-md border border-[#1e1e2e] bg-[#111118] p-4">
      <h3 className="text-xs font-medium uppercase tracking-wider text-[#71717a] mb-4">Daily Spend (14 days)</h3>
